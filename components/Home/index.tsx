...
export default function Home() {
  return (
    <View style={styles.main}>
      ...
      <Items image={require("../../assets/img/Tsurenai.webp")} title={"Tsurenai hodo aokute"} desc={"A chave conhecida como “curiosidade”… Que abriu as portas do abismo. A história de terror e sensualidade que foi iniciada, se tornou o mais puro prazer."}/>
